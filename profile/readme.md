...
| <a href="https://github.com/tunebond/worm.link"><img src='https://github.com/tunebond/worm.link/blob/make/view/base.svg?raw=true' width='128'></a> | This is a collection of "grammars", written in [`link`](https://github.com/tunebond/link). These are pattern recognizers for generating object structures out of text or binary strings, and doing the reverse, of generating text/binaries from objects. They are defined in a language agnostic way.                                                                                                     |
