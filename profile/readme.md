...
The <a href='https://github.com/wavebond/base.link'>base</a> <a href='https://github.com/wavebond/link'>link</a> knows to plant the seed<br/>
A dark energy finds your need<br/>
And appeals to you through hide and seek<br/>
</em></p>
...
Welcome to WaveBond's page. We work with a few main things:
...
We wrote [`link`](https://github.com/wavebond/link), a super minimal tree-based data modeling language sort of like YAML/JSON/XML, which is in some ways more readable and concise than them. That project is basically finished. The spec is defined in that repo, and a primitive parser is implemented to convert link text into a tree. The next step is taking the link tree and compiling it into runnable code via [`base.link`](https://github.com/wavebond/base.link).
