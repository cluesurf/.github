...
<p align='center'><img src='https://github.com/textsurf/.github/blob/make/view/mountains.svg?raw=true' height='256'></a></p>

<p align='center'><img src='https://github.com/textsurf/.github/blob/make/view/monkey.svg?raw=true' height='256'></a></p>
...
<p align='center'>
  <img src='https://github.com/textsurf/.github/blob/make/view/bush.svg?raw=true' height='312'>
</p>
...
|  <a href="https://beat.land"><img src='https://github.com/textsurf/.github/blob/make/view/rock.svg?raw=true' height="92"></a>  | A modern model of the universe. The museum entrypoint itself.                                                     |
|                                                [`tune.land`](https://tune.land)                                                | **The Tune Spoken Language**                                                                                      |
|   <a href="https://tune.land"><img src='https://github.com/textsurf/tune/blob/make/view/bird.svg?raw=true' height="92"></a>    | A natural language of a minimal memorizable set of concepts, used to model and play with reality in a deeper way. |
|                                                [`tone.land`](https://tone.land)                                                | **The Tone Writing System**                                                                                       |
|  <a href="https://tone.land"><img src='https://github.com/textsurf/.github/blob/make/view/owl.svg?raw=true' height="92"></a>   | A simplified and uniform writing system for all the languages of Earth.                                           |
|                                                [`base.link`](https://base.link)                                                | **The BaseLink Programming Language**                                                                             |
| <a href="https://base.link"><img src='https://github.com/textsurf/base.link/blob/make/view/base.svg?raw=true' height="92"></a> | A "modeling language" where you write in concise and minimalistic trees of text.                                  |
...
|                                                                        Code                                                                        | Note                                                                                                                                                                                                                                                                                                                                                                                                       |
| :------------------------------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|                                                     [`link`](https://github.com/textsurf/link)                                                     | **The Modeling Language**                                                                                                                                                                                                                                                                                                                                                                                  |
|      <a href="https://github.com/textsurf/link"><img src='https://github.com/textsurf/link/blob/make/view/link.svg?raw=true' width='128'></a>      | This is the "data modeling language" which [`base.link`](https://github.com/textsurf/base.link) extends into a programming language and environment. There's not much too this piece other than the syntax.                                                                                                                                                                                                |
|                                                [`base.link`](https://github.com/textsurf/base.link)                                                | **A Link Text Programming Framework**                                                                                                                                                                                                                                                                                                                                                                      |
| <a href="https://github.com/textsurf/base.link"><img src='https://github.com/textsurf/base.link/blob/make/view/base.svg?raw=true' width='128'></a> | This is one example tool for building [`link`](https://github.com/textsurf/link) programs. It is a Link Text package manager, as well as its compiler. The main [**docs**](https://github.com/textsurf/base.link/blob/make/book/tree/code-tree/base.link) are found there for all link-related projects.                                                                                                   |
|                                                [`bind.link`](https://github.com/textsurf/bind.link)                                                | **The BaseLink Platform Binding Library**                                                                                                                                                                                                                                                                                                                                                                  |
| <a href="https://github.com/textsurf/bind.link"><img src='https://github.com/textsurf/bind.link/blob/make/view/view.svg?raw=true' height='92'></a> | This is a library of all the native _types_ for each programming language / environment (JavaScript, Swift, Rust, Kotlin). This gives us the information necessary to compile Link Text down to native code in each environment.                                                                                                                                                                           |
|                                                [`bolt.link`](https://github.com/textsurf/bolt.link)                                                | **The BaseLink Standard Library**                                                                                                                                                                                                                                                                                                                                                                          |
| <a href="https://github.com/textsurf/bolt.link"><img src='https://github.com/textsurf/bolt.link/blob/make/view/view.svg?raw=true' height='92'></a> | This is the foundational standard library. It includes all your standard primitive data types, as well as other well-defined data models which are useful in standard apps. It implements these in Node.js, the Browser, Rust (Linux server-side), Swift, and Kotlin (down the road).                                                                                                                      |
|                                                [`mesh.link`](https://github.com/textsurf/mesh.link)                                                | **The BaseLink Compiler Framework**                                                                                                                                                                                                                                                                                                                                                                        |
| <a href="https://github.com/textsurf/mesh.link"><img src='https://github.com/textsurf/mesh.link/blob/make/view/base.svg?raw=true' height='92'></a> | This is the compiler, which takes the Link Text AST and transforms it into an AST based on your structure definitions, and then does the typechecking and typeinference and such to verify its correctness statically. Then it generates the JS or other target language output.                                                                                                                           |
|                                                [`crow.link`](https://github.com/textsurf/crow.link)                                                | **The BaseLink UI Framework**                                                                                                                                                                                                                                                                                                                                                                              |
| <a href="https://github.com/textsurf/crow.link"><img src='https://github.com/textsurf/crow.link/blob/make/view/view.svg?raw=true' height='92'></a> | This is eventually going to be the UI framework, encompassing what React.js does, and also handling other graphics related stuff.                                                                                                                                                                                                                                                                          |
|                                                [`star.link`](https://github.com/textsurf/star.link)                                                | **The BaseLink Third-Party API Integration Library**                                                                                                                                                                                                                                                                                                                                                       |
| <a href="https://github.com/textsurf/star.link"><img src='https://github.com/textsurf/star.link/blob/make/view/view.svg?raw=true' width='128'></a> | This is a collection of REST (and potentially other) API endpoints, written in [`link`](https://github.com/textsurf/link). It is going to be used to provide integration with many services in the [`base.link`](https://github.com/textsurf/base.link) / [`link`](https://github.com/textsurf/link) ecosystem, though it is written in a language-agnostic way (i.e. you could use this in any language). |
|                                                [`worm.link`](https://github.com/textsurf/worm.link)                                                | **The BaseLink Content Grammar Library**                                                                                                                                                                                                                                                                                                                                                                   |
| <a href="https://github.com/textsurf/worm.link"><img src='https://github.com/textsurf/worm.link/blob/make/view/view.svg?raw=true' width='128'></a> | This is a collection of "grammars", written in [`link`](https://github.com/textsurf/link). These are pattern recognizers for generating object structures out of text or binary strings, and doing the reverse, of generating text/binaries from objects. They are defined in a language agnostic way.                                                                                                     |
|                                                [`seed.link`](https://github.com/textsurf/seed.link)                                                | **The BaseLink Math Library**                                                                                                                                                                                                                                                                                                                                                                              |
| <a href="https://github.com/textsurf/seed.link"><img src='https://github.com/textsurf/seed.link/blob/make/view/seed.svg?raw=true' width='128'></a> | This is a collection of mathematical formalizations, written in [`link`](https://github.com/textsurf/link). These are going to be used, following along the lines of the HoTT project, as a foundational model of mathematics for use in a programming environment.                                                                                                                                        |
