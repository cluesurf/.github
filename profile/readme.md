...
| <a href="https://github.com/tunebond/bolt.link"><img src='https://github.com/tunebond/bolt.link/blob/make/view/view.svg?raw=true' width='92'></a>  | This is the foundational standard library. It includes all your standard primitive data types, as well as other well-defined data models which are useful in standard apps. It implements these in Node.js, the Browser, Rust (Linux server-side), Swift, and Kotlin (down the road).                                                                                                                      |
