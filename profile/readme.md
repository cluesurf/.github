...
|                                                [`base.surf`](https://base.surf)                                                | **The BaseLink Package Manager**                                                                                  |
...
| <a href="https://github.com/termsurf/base.note"><img src='https://github.com/termsurf/base.note/blob/make/view/base.svg?raw=true' width='128'></a> | This is one example tool for building [`note`](https://github.com/termsurf/link) programs. It is a Link Text package manager, as well as its compiler. The main [**docs**](https://github.com/termsurf/base.note/blob/make/book/tree/code-tree/base.note) are found there for all link-related projects.                                                                                                   |
|                                                [`bind.note`](https://github.com/termsurf/bind.note)                                                | **The BaseLink Platform Binding Library**                                                                                                                                                                                                                                                                                                                                                                  |
...
|                                                [`bolt.note`](https://github.com/termsurf/bolt.note)                                                | **The BaseLink Standard Library**                                                                                                                                                                                                                                                                                                                                                                          |
...
|                                                [`mesh.note`](https://github.com/termsurf/mesh.note)                                                | **The BaseLink Compiler Framework**                                                                                                                                                                                                                                                                                                                                                                        |
...
|                                                [`crow.note`](https://github.com/termsurf/crow.note)                                                | **The BaseLink UI Framework**                                                                                                                                                                                                                                                                                                                                                                              |
...
|                                                [`star.note`](https://github.com/termsurf/star.note)                                                | **The BaseLink Third-Party API Integration Library**                                                                                                                                                                                                                                                                                                                                                       |
...
|                                                [`worm.note`](https://github.com/termsurf/worm.note)                                                | **The BaseLink Content Grammar Library**                                                                                                                                                                                                                                                                                                                                                                   |
...
|                                                [`seed.note`](https://github.com/termsurf/seed.note)                                                | **The BaseLink Math Library**                                                                                                                                                                                                                                                                                                                                                                              |
