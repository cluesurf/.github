...
|                                                [`bolt.link`](https://github.com/tunebond/bolt.link)                                                | **The Base Link Platform Binding Library**                                                                                                                                                                                                                                                                                                                                                                 |
...
|                                                [`wolf.link`](https://github.com/tunebond/wolf.link)                                                | **The Base Link Standard Library**                                                                                                                                                                                                                                                                                                                                                                         |
| <a href="https://github.com/tunebond/wolf.link"><img src='https://github.com/tunebond/wolf.link/blob/make/view/view.svg?raw=true' width='128'></a> | This is the foundational standard library. It includes all your standard primitive data types, as well as other well-defined data models which are useful in standard apps. It implements these in Node.js, the Browser, Rust (Linux server-side), Swift, and Kotlin (down the road).                                                                                                                      |
|                                                [`moon.link`](https://github.com/tunebond/moon.link)                                                | **The Base Link Framework**                                                                                                                                                                                                                                                                                                                                                                                |
| <a href="https://github.com/tunebond/moon.link"><img src='https://github.com/tunebond/moon.link/blob/make/view/view.svg?raw=true' width='128'></a> | This is a higher level framework, supporting Node.js, Browser, Swift (iOS, MacOS, etc.), Windows (JavaScript), Linux (Rust), and Kotlin (Android). It aims to provide a rich and robust cross-platform API to everything you need to build web apps.                                                                                                                                                       |
