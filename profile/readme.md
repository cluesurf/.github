...
|                                               [`base.surf`](https://base.surf)                                               | **BaseTree: A TreeCode Programming Framework**                                                                    |
|  <a href="https://base.surf"><img src='https://github.com/termsurf/base/blob/make/view/tree.gif?raw=true' height="92"></a>   | A "programming framework" built on top of TreeCode, transforming it into something like code.                     |
...
|   <a href="https://github.com/termsurf/tree"></a>    | This is the "data modeling programming language" which [`base`](https://github.com/termsurf/base) extends into a programming language and environment. There's not much too this piece other than the syntax.                                                                                                                                                                                    |
| [`note.tree`](https://github.com/termsurf/note.tree) | **BaseTree: A Programming Framework for TreeCode**                                                                                                                                                                                                                                                                                                                                               |
| <a href="https://github.com/termsurf/note.tree"></a> | This is one example tool for building [`tree`](https://github.com/termsurf/tree) programs. It is a TreeCode package manager, as well as its compiler.                                                                                                                                                                                                                                            |
| [`bind.tree`](https://github.com/termsurf/bind.tree) | **The BaseTree Platform Binding Library**                                                                                                                                                                                                                                                                                                                                                        |
...
| [`base.tree`](https://github.com/termsurf/base.tree) | **The BaseTree Standard Library**                                                                                                                                                                                                                                                                                                                                                                |
...
| [`deck.tree`](https://github.com/termsurf/deck.tree) | **The BaseTree Package Manager Library**                                                                                                                                                                                                                                                                                                                                                         |
...
| [`make.tree`](https://github.com/termsurf/make.tree) | **The BaseTree Compiler Library**                                                                                                                                                                                                                                                                                                                                                                |
...
| [`flow.tree`](https://github.com/termsurf/flow.tree) | **The BaseTree Runtime Library**                                                                                                                                                                                                                                                                                                                                                                 |
...
| [`view.tree`](https://github.com/termsurf/view.tree) | **The BaseTree Graphics Library**                                                                                                                                                                                                                                                                                                                                                                |
...
| [`link.tree`](https://github.com/termsurf/link.tree) | **The BaseTree Third-Party API Integration Library**                                                                                                                                                                                                                                                                                                                                             |
| <a href="https://github.com/termsurf/link.tree"></a> | This is a collection of REST (and potentially other) API endpoints, written in [`tree`](https://github.com/termsurf/tree). It is going to be used to provide integration with many services in the [`base`](https://github.com/termsurf/base) / [`tree`](https://github.com/termsurf/tree) ecosystem, though it is written in a language-agnostic way (i.e. you could use this in any language). |
| [`text.tree`](https://github.com/termsurf/text.tree) | **The BaseTree Content Grammar Library**                                                                                                                                                                                                                                                                                                                                                         |
| <a href="https://github.com/termsurf/text.tree"></a> | This is a collection of "grammars", written in [`tree`](https://github.com/termsurf/tree). These are pattern recognizers for generating object structures out of text or binary strings, and doing the reverse, of generating text/binaries from objects. They are defined in a language agnostic way.                                                                                           |
| [`form.tree`](https://github.com/termsurf/form.tree) | **The BaseTree Math Library**                                                                                                                                                                                                                                                                                                                                                                    |
